...
import com.mindgarden.mindgarden.ui.password.PasswordActivity
...
//                            myWebView.destroy()
                            ...
                            if (whyOpen == "deleteUser") {
                                ...
                                if (SharedPreferenceController.getPassword(this@WebviewLoginActivity) == "") {
                                    Log.e(
                                        "webView main으로 넘어가기전",
                                        TokenController.getAccessToken(this@WebviewLoginActivity)
                                    )
                                    Log.e(
                                        "webView main으로 넘어가기전",
                                    ...
                                    Log.e(
                                        "webView main으로 넘어가기전",
                                        SharedPreferenceController.getUserName(this@WebviewLoginActivity)
                                    )
                                    Log.e(
                                        "webView main으로 넘어가기전",
                                        SharedPreferenceController.getUserMail(this@WebviewLoginActivity)
                                    )
    ...
    inner class MyJavaScriptInterface {
        ...
        fun getResponse(response1: String) {
            ...
            if (json == null || !json.has("data")) {
                ...
                Log.e(
                    "Webview_accessToken_startTime",
                    TokenController.getTimeAccessToken(this@WebviewLoginActivity).toString()
                )
                ...
                Log.e(
                    "Webview_accessToken_exp_in_DB",
                    TokenController.getExpAccessToken(this@WebviewLoginActivity).toString()
                )
