...
interface DiaryDate {
    ...
    fun getDiaryListDate(d: String) = getFormat(d, SimpleDateFormat("yyyy년 MM월", Locale.ENGLISH))

    fun getDay(d: String) = getFormat(d, SimpleDateFormat("dd", Locale.ENGLISH))
    ...
    fun getTime(d: String) = getFormat(d, SimpleDateFormat("HH:mm:ss", Locale.ENGLISH))
}