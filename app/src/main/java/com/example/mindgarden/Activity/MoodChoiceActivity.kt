...
class MoodChoiceActivity : AppCompatActivity() {
    ...
    private fun configureRecyclerView(){
      ...
      //  val icn11 = drawableToBitmap(R.drawable.)
        ...
        dataList.add(MoodChoiceData(icn3, "그냥 그래요"))
        dataList.add(MoodChoiceData(icn4, "심심해요"))
        dataList.add(MoodChoiceData(icn5, "재미있어요"))
        dataList.add(MoodChoiceData(icn6, "설레요"))
        dataList.add(MoodChoiceData(icn7, "별로에요"))
